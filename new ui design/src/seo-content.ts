...
const seeds: CourierSeoSeed[] = [
  {
    ...
    title: 'TCS Tracking Pakistan | Track TCS Shipment Status Online',
    description: 'Track TCS shipments online with a dedicated TCS tracking page that shows the latest available shipment details and delivery updates.',
  ...
  },
  {
    ...
    title: 'Leopard Tracking Pakistan | Leopard Courier Tracking Number Guide',
    description: 'Use this dedicated leopard tracking page to check leopard courier tracking status, understand your leopard tracking number, and view the latest shipment updates.',
  ...
  },
  {
    ...
    title: 'Pakistan Post Tracking | Pak Post Tracking, UMS Tracking and GPO Tracking',
    description: 'Track Pakistan Post shipments online with support for pakistan post tracking, pak post tracking, ums tracking, gpo tracking, and related mail office updates.',
  ...
  },
  {
    ...
    title: 'PostEx Tracking Pakistan | Track PostEx Orders Online',
    description: 'Track PostEx shipments online with a dedicated page for order movement, delivery updates, and recent status history.',
  ...
  },
  {
    ...
    title: 'M&P Tracking | M and P Tracking, M&P Courier Tracking and Tracking Number Help',
    description: 'Use this dedicated m&p tracking page to check m and p tracking updates, understand your m&p tracking number, and monitor courier movement.',
  ...
  },
  {
    ...
    title: 'Daewoo Tracking Pakistan | Daewoo FastEx Cargo Tracking',
    description: 'Track Daewoo FastEx cargo online with a dedicated daewoo tracking page that shows booking details, summary information, and latest shipment status.',
  ...
  } as CourierSeoSeed & { ogTitle: string; ogDescription: string },
  {
    ...
    title: 'Trax Tracking Pakistan | Track Trax Shipment Status Online',
    description: 'Track Trax shipments online with a dedicated page for shipment status, shipper and consignee details, and latest tracking events.',
  ...
  },
  {
    ...
    title: 'BlueEx Tracking Pakistan | Track BlueEx Shipment Status Online',
    description: 'Track BlueEx shipments online with a dedicated page for delivery movement, latest tracking updates, and shipment history.',
